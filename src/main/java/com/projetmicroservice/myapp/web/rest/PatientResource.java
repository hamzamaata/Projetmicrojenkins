...
import com.projetmicroservice.myapp.repository.PatientRepository;
...
/**
 * REST controller for managing {@link com.projetmicroservice.myapp.domain.Patient}.
 */
@RestController
...
public class PatientResource {
    ...
    private static final String ENTITY_NAME = "projetmicroservicePatient";
    ...
    public ResponseEntity<Patient> partialUpdatePatient(
        ...
        Optional<Patient> result = patientRepository
            ...
            .map(existingPatient -> {
                ...
                if (patient.getHistoriqueMedical() != null) {
                    existingPatient.setHistoriqueMedical(patient.getHistoriqueMedical());
                }
