...
class MedecinResourceIT {
    ...
    public static Medecin createEntity(EntityManager em) {
        Medecin medecin = new Medecin().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).role(DEFAULT_ROLE).disponibilite(DEFAULT_DISPONIBILITE);
        return medecin;
    }
    ...
    public static Medecin createUpdatedEntity(EntityManager em) {
        Medecin medecin = new Medecin().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).role(UPDATED_ROLE).disponibilite(UPDATED_DISPONIBILITE);
        return medecin;
    }
    ...
    void createMedecin() throws Exception {
        ...
        assertThat(testMedecin.getRole()).isEqualTo(DEFAULT_ROLE);
        assertThat(testMedecin.getDisponibilite()).isEqualTo(DEFAULT_DISPONIBILITE);
    }
    ...
    void putExistingMedecin() throws Exception {
        ...
        updatedMedecin.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).role(UPDATED_ROLE).disponibilite(UPDATED_DISPONIBILITE);
        ...
        assertThat(testMedecin.getRole()).isEqualTo(UPDATED_ROLE);
        assertThat(testMedecin.getDisponibilite()).isEqualTo(UPDATED_DISPONIBILITE);
    }
    ...
    void partialUpdateMedecinWithPatch() throws Exception {
        ...
        partialUpdatedMedecin.prenom(UPDATED_PRENOM).role(UPDATED_ROLE);
    ...
    void fullUpdateMedecinWithPatch() throws Exception {
        ...
        partialUpdatedMedecin.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).role(UPDATED_ROLE).disponibilite(UPDATED_DISPONIBILITE);
